...
class TestEstrattoconto(TestCase):
    def test_base_path_1(self) -> None:
        ...
        expected_rows = [
            ...
            Row(date(2022, 8, 9), date(2022, 8, 9), Decimal('626.92'), None,
            ...
            Row(date(2022, 8, 10), date(2022, 8, 7), Decimal('18.10'), None,
